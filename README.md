...
<html>
    ...
    <body>
        ...
        <footer class="bg-dark text-white text-center py-3">
            <p>&copy; Designed and Developed by DAKSHINA MOORTHY N D</p>
        </footer>
...
## OUTPUT:
![image](https://github.com/user-attachments/assets/83f41f5b-054d-4c1d-8364-8071f8ad485d)
![image](https://github.com/user-attachments/assets/890a95b1-6bf8-4ace-9e2b-a7ad52894e5a)
